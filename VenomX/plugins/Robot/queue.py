...
from VenomX.utils import (Venombin, get_channeplayCB,
                              seconds_to_min)
from VenomX.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://te.legra.ph/file/7753e6b9852ea5c7ef074.jpg",
        caption=_["queue_1"],
    )
