...
from VenomX.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from VenomX.utils.inline.help import (help_back_markup,
                                          private_help_panel)
...
async def helper_private(
    ...
    if is_callback:
        ...
        await update.reply_sticker("CAACAgUAAxkDAAIM8mND6eHk4zel2QE5gLFIPYGPAAGeVAAC3gYAAtFpIFUx-IwYBM9tWCoE")
