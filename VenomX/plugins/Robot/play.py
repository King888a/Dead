...
from VenomX import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
...
from VenomX.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from VenomX.utils.database import is_served_user
...
@app.on_callback_query(
    filters.regex("VenomPlaylists") & ~BANNED_USERS
)
@languageCB
